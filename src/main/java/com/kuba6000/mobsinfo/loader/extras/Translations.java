...
public enum Translations {
    ...
    MINEFANTASY2_GUTS_LOOTING,
    MINEFANTASY2_BURNING,
    MINEFANTASY2_NOT_BURNING,
    MINEFANTASY2_HUNTING_WEAPON,
    MINEFANTASY2_BOW_SKELETON,
    MINEFANTASY2_ORIGINAL_ITEM,
    MINEFANTASY2_TAGGED_SACK,
    LOOTPLUSPLUS_PLAYER_CREDIT,
    LOOTPLUSPLUS_SKELETON_KILL,
